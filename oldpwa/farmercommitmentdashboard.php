...
?>
    ...
    $query001 = mysqli_query($conn, "SELECT * FROM commitment_order_dashboard WHERE trans_adate!='0000-00-00' ORDER BY trans_adate ASC LIMIT $offset, $records_per_page");

    // Calculate the total number of pages
    $total_records_query = mysqli_query($conn, "SELECT COUNT(*) AS total_records FROM commitment_order_dashboard WHERE trans_adate!='0000-00-00'");
        ...
        <tbody>
            <?php while ($result001 = mysqli_fetch_array($query001)): ?>
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo $result001['vendor_orders']; ?> kg</td>
                    <td style="text-align: right;"><?php echo $result001['farmer_commitment']; ?> kg</td>                  
                    <td style="text-align: right;"><?php echo $sub_amount = $result001['vendor_orders'] - $result001['farmer_commitment']; ?> kg</td>
...
<script>
 $(document).ready(function() {
            $('#search').keyup(function() {
                ...
                $.post('farmercommitmentdashboardfetch.php', { searchText: searchText }, function(data) {
