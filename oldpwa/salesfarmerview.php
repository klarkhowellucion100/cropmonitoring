                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="myModalLabel">Update Sales Record</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                                </button>
                                                        </div>
                                                        <form action="agriboostdmstransactions/salesfarmerviewupdateprocess.php" method="POST" enctype="multipart/form-data">
                                ...
                                <table id="table_collect" class="table table-striped table-bordered wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                     ...
                                     <tbody>
                                         <?php
                                             ...
                                             $query001 = mysqli_query($conn,"SELECT * FROM sales_farmer");
...
<script>         
    ...
    $('.farmerinfo').click(function(){
        ...
        $.ajax({
                    url:"agriboostdmstransactions/salesfarmerviewupdate.php",
                    method:"POST",
    ...
    function addcomm(){
        var data = {                                 
            ...
            sellertype: $("#sellertype").val(),
                   ...
                   $.ajax({
                           url:"agriboostdmstransactions/salesfarmerprocess.php",
                           method:"POST",
                           data:data,
...
if (result.isConfirmed) {
  swalWithBootstrapButtons.fire(
    ...
    'success'
      ...
      window.location.href='agriboostdmstransactions/salesfarmerviewdelete.php?delete=' +delid+ '';
      });
