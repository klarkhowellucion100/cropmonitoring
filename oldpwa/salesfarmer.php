                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        ...
                                                        <h5 class="font-size-16 mb-0"><?php  echo number_format($result001['total_agrihub_commqty'],2); ?> kg</h5>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        <p class="text-muted mb-2">Sales from AgriHub(Php)</p>
                                                        <h5 class="font-size-16 mb-0">P <?php echo number_format($result001['total_agrihub_sales'],2); ?></h5>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        <p class="text-muted mb-2">Volume Outside(kg)</p>
                                                        <h5 class="font-size-16 mb-0"><?php echo number_format($result001['total_other_commqty'],2); ?>kg</h5>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        <p class="text-muted mb-2">Sales Outside(Php)</p>
                                                        <h5 class="font-size-16 mb-0">P <?php echo number_format($result001['total_other_sales'],2); ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
