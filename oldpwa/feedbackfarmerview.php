                        ...
                        <div id="myModalUpdate" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="agriboostdmstransactions/feedbackfarmerupdateprocess.php" method="POST" enctype="multipart/form-data">
                                ...
                                <table id="table_collect" class="table table-striped table-bordered wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                     ...
                                     <tbody>
                                         <?php
                                             ...
                                             $query001 = mysqli_query($conn,"SELECT * FROM feedbackrecord WHERE fnametype='Farmer'");
...
<script>         
    ...
    $('.farmerinfo').click(function(){
        ...
        $.ajax({
                    url:"agriboostdmstransactions/feedbackvendorupdate.php",
                    method:"POST",
...
if (result.isConfirmed) {
  swalWithBootstrapButtons.fire(
    ...
    'success'
      ...
      window.location.href='agriboostdmstransactions/feedbackfarmerdelete.php?delete=' +delid+ '';
      });
