    ...
    function addcomms(){
        var data = {                                 
            ...
            dt_joined: $("#dt_joined").val(),
                   ...
                   $.ajax({
                           url:"agriboostdmstransactions/vendorregistrationprocess.php",
                           method:"POST",
                           data:data,
  ...
  if (result.isConfirmed) {
    swalWithBootstrapButtons.fire(
      ...
      'success'
        ...
        window.location.href='agriboostdmstransactions/vendorregistrationdelete.php?delete=' +delid+ '';
        });
...
<script>         
    ...
    $('.vendorinfo').click(function(){
        var vendorid = $(this).data('id');
    
        $.ajax({
                    url:"agriboostdmstransactions/vendorregistrationupdate.php",
                    method:"POST",
