                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="commo">
                                                                        <label for="numdel">No. of Deliveries Made</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="commo">
                                                                        ...
                                                                        <input type="text" readonly class="form-control" id="fnametype" name="fnametype" value='Farmer'>   
                                                                    </div>                                        
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label" style="color:green;">1. Reason/s for delivering to AgriHub</label>
                                                                    <div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <h5 class="font-size-15 mb-3" style="color:green;">2. Are you happy with your delivery to AgriHub?</h5>                                                                
                                                                ...
                                                                <div class="mb-3">
                                                                    <h5 class="font-size-15 mb-3" style="color:green;">3. Are you agreeable with AgriHub's buying price?</h5>                                                                
                                                                ...
                                                                <div class="mb-3">
                                                                    <h5 class="font-size-15 mb-3" style="color:green;">4. Did you profit from your delivery to AgriHub?</h5>                                                                
                                                                ...
                                                                <div class="mb-3">
                                                                    <h5 class="font-size-15 mb-3" style="color:green;">5. Will you continue delivering to AgriHub?</h5>                                                                
                                                                ...
                                                                <div class="mb-3">
                                                                    <h5 class="font-size-15 mb-3" style="color:green;">7. Will you recommend AgriHub to other farmers? (NPS)</h5>                                                                
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label" style="color:green;">9. Suggestions on how to improve the AgriBOOST Project/AgriHub's operation</label>
                                                                    <div>
...
<div id="feebackmain">
                    ...
                    <?php
                        ...
                        $query001 = mysqli_query($conn,"SELECT * FROM feedbackrecord WHERE fnametype='Farmer' GROUP BY fname");
...
<script>         
    ...
    $('.feedbackfetch').click(function(){
        ...
        $.ajax({
                    url:"agriboostdmstransactions/feedbackfarmerfetch.php",
                    method:"POST",
    ...
    function addcomm(){
        var data = {                                 
            ...
            fnametype: $("#fnametype").val(),
                   ...
                   $.ajax({
                           url:"agriboostdmstransactions/feedbackvendorprocess.php",
                           method:"POST",
                           data:data,
