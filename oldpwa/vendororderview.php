...
?>
    ...
    $query001 = mysqli_query($conn, "SELECT * FROM erp_record WHERE trans_partnertype='Vendor' LIMIT $offset, $records_per_page");

    // Calculate the total number of pages
    $total_records_query = mysqli_query($conn, "SELECT COUNT(*) AS total_records FROM erp_record WHERE trans_partnertype='Vendor'");
  ...
  if (result.isConfirmed) {
    swalWithBootstrapButtons.fire(
      ...
      'success'
        ...
        window.location.href='agriboostdmstransactions/vendororderdelete.php?delete=' +delid+ '';
        });
...
<script>
    ...
    $('#filter001').click(function(){
        ...
        var dateto = $('#dateto').val();  
            ...
            $.ajax({
                url:"agriboostdmstransactions/vendororderviewfetch.php",
                method:"POST",
...
<script>
 $(document).ready(function() {
            $('#search').keyup(function() {
                ...
                $.post('vendororderviewsearch.php', { searchText: searchText }, function(data) {
