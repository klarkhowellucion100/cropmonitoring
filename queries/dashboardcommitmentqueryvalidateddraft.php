...
WHERE
    registrationhubpos.fname = production_validated_cms.name AND YEAR(production_validated_cms.date_harvest) = '$yearnow' AND (production_validated_cms.status_comm='Committed' OR production_validated_cms.status_comm='Uncommitted')
GROUP BY
    production_validated_cms.name,
    production_validated_cms.comm,
    production_validated_cms.code
...
production_validated_cms, registrationhubpos
WHERE
registrationhubpos.fname = production_validated_cms.name AND YEAR(production_validated_cms.date_harvest) = '$year_now' AND (production_validated_cms.status_comm='Committed' OR production_validated_cms.status_comm='Uncommitted')
GROUP BY
production_validated_cms.comm
ORDER BY
