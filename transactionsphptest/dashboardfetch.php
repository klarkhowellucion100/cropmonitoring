                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn, "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Vendor' AND (trans_adate BETWEEN '$datefrom' AND '$dateto') ");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                                                    $sumsales2 = $result['SUM(pay_subtotal_final)'];                                                               
                                                ?>
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Farmer' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                ...
                                <?php
                                    include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subcom_final) FROM erp_record WHERE trans_partnertype='Vendor' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subcom_final) FROM erp_record WHERE trans_partnertype='Farmer' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_commitvol) FROM erp_record WHERE trans_partnertype='Vendor' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_commitvol) FROM erp_record WHERE trans_partnertype='Farmer' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                                                ...
                                                                $qr02 = "SELECT COUNT(trans_code) FROM erp_record WHERE trans_commitvol!='0' AND trans_partnertype='Farmer'  AND (trans_adate BETWEEN '$datefrom' AND '$dateto') GROUP BY trans_partner";
                                                                $result02 = mysqli_query($conn,$qr02);
                                                                $numRow02 = mysqli_num_rows($result02);
                                                            ?>
                                        <h4 class="mb-1 mt-1"> <span data-plugin="counterup"><?php echo number_format($numRow02, 2);?></span> kg</h4>
                                        <p class="text-muted mb-0">Exp Farmers Delivery</p>
                                    </div>
                                    <!--<p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>10.51%</span> since last week
                                    </p>-->
                                </div>
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn, "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Vendor'  AND trans_status='Paid' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Farmer'  AND trans_status='Paid' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_volume) FROM erp_record WHERE trans_partnertype='Vendor' AND (trans_adate BETWEEN '$datefrom' AND '$dateto') ");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_volume) FROM erp_record WHERE trans_partnertype='Farmer' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                                                include_once 'db.inc.php';
                                                                $qr02a = "SELECT COUNT(trans_code) FROM erp_record WHERE trans_volume!='0' AND trans_partnertype='Farmer' AND (trans_adate BETWEEN '$datefrom' AND '$dateto') GROUP BY trans_partner";
                                                                $result02a = mysqli_query($conn,$qr02a);
                                                                $numRow02a = mysqli_num_rows($result02a);
                                                            ?>
                                        <h4 class="mb-1 mt-1"> <span data-plugin="counterup"><?php echo number_format($numRow02a, 2);?></span> kg</h4>
                            ...
                            <div class="card">
                                ...
                                <div>
                                    <div id='chart_commit'></div>
                                            ...
                                            <?php  $sql001 = "SELECT trans_partner, trans_partnertype, SUM(trans_commitvol), SUM(trans_volume) FROM erp_record WHERE (trans_adate BETWEEN '$datefrom' AND '$dateto') AND trans_partnertype='Farmer' GROUP BY trans_partner";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id='chart_commodity'></div>
                                            ...
                                            <?php  $sql002 = "SELECT trans_comm, SUM(trans_commitvol), SUM(trans_volume) FROM erp_record WHERE (trans_adate BETWEEN '$datefrom' AND '$dateto') AND trans_partnertype='Farmer' GROUP BY trans_comm";
                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable2" style="width:100%;" class="display table table-striped table-bordered wrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            include 'db.inc.php';
                                                            $query1 = mysqli_query($conn,"SELECT trans_partner, trans_comm, trans_commitvol, trans_volume, trans_volume-trans_commitvol AS diff  FROM erp_record WHERE trans_partnertype='Farmer' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" style="width:100%;" class="display table table-striped table-bordered wrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            include 'db.inc.php';
                                                            $query1 = mysqli_query($conn,"SELECT trans_partner, trans_comm, trans_commitvol, trans_volume, trans_volume-trans_commitvol AS diff  FROM erp_record WHERE trans_partnertype='Vendor' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
                                                            while($result1 = mysqli_fetch_array($query1)): ?>
                                                            <tr>
                                                                <td><?php echo $result1 ['trans_partner'];?></td>
                                                                <td style="text-align: left;"><?php echo $result1 ['trans_comm'];?></td>  
