                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn, "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Vendor' AND trans_adate='$date_f'");
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                ...
                                <?php
                                    include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subcom_final) FROM erp_record WHERE trans_partnertype='Vendor' AND trans_adate='$date_f'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subcom_final) FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_commitvol) FROM erp_record WHERE trans_partnertype='Vendor' AND trans_adate='$date_f'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_commitvol) FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                                                ...
                                                                $qr02 = "SELECT COUNT(trans_code) FROM erp_record WHERE trans_commitvol!='0' AND trans_partnertype='Farmer' AND trans_adate='$date_f' GROUP BY trans_partner";
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn, "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Vendor' AND trans_adate='$date_f' AND trans_status='Paid'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f' AND trans_status='Paid'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_volume) FROM erp_record WHERE trans_partnertype='Vendor' AND trans_adate='$date_f' ");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(trans_volume) FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f'");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                        ...
                        <div class="col-md-6 col-xl-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php 
                                                                include_once 'db.inc.php';
                                                                $qr02a = "SELECT COUNT(trans_code) FROM erp_record WHERE trans_volume!='0' AND trans_partnertype='Farmer' AND trans_adate='$date_f' GROUP BY trans_partner";
                            ...
                            <div class="card">
                                ...
                                <div>
                                    <div id='chart_commit'></div>
                                            ...
                                            <?php  $sql001 = "SELECT trans_partner, trans_partnertype, SUM(trans_commitvol), SUM(trans_volume) FROM erp_record WHERE trans_adate='$date_f' AND trans_partnertype='Farmer' GROUP BY trans_partner";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id='chart_commodity'></div>
                                            ...
                                            <?php  $sql002 = "SELECT trans_comm, SUM(trans_commitvol), SUM(trans_volume) FROM erp_record WHERE trans_adate='$date_f' AND trans_partnertype='Farmer' GROUP BY trans_comm";
                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable2" style="width:100%;" class="display table table-striped table-bordered wrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            include 'db.inc.php';
                                                            $query1 = mysqli_query($conn,"SELECT trans_partner, trans_comm, trans_commitvol, trans_volume, trans_volume-trans_commitvol AS diff  FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f'");
                                                ...
                                                <div class="table-responsive">
                                                    <table id="myTable" style="width:100%;" class="display table table-striped table-bordered wrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            include 'db.inc.php';
                                                            $query1 = mysqli_query($conn,"SELECT trans_partner, trans_comm, trans_commitvol, trans_volume, trans_volume-trans_commitvol AS diff  FROM erp_record WHERE trans_partnertype='Vendor' AND trans_adate='$date_f'");
                                                            while($result1 = mysqli_fetch_array($query1)): ?>
                                                            <tr>
                                                                <td><?php echo $result1 ['trans_partner'];?></td>
                                                                <td style="text-align: left;"><?php echo $result1 ['trans_comm'];?></td>  
