                                ...
                                <div class="row">
                                    ...
                                    ?>
                                            ...
                                            <div class="mb-3" >
                                                ...
                                                <input type="text" style="display:none;" class="form-control" required id="trans_price" value="<?php echo $q['price'];?>">      
                                                <p><?php echo $q['price'];?></p>                                        
                                            </div>

                                            <div class="mb-3">
                                                <label for="dund" class="form-label"> Ordered Volume (kg) <span style="color:crimson;"></span></label>
