            ...
            <div id="type_purchase">
                <div class="row">
                    ...
                    ?>
                        ...
                        <?php
                        $query1 = mysqli_query($conn,"SELECT * FROM commodityhubpos  WHERE `sellingtype`='Farmgate' ORDER BY commodity ASC");
     ...
     function addproduct(){
                            ...
                            function DeleteUser(deleteid){
                                ...
                                if(confirm("Are you sure you want to delete this data?")){
                                    $.ajax({
                                                url:"walkinsupplytransdelete.php",
                                                method:"POST",
            ...
            <div class="card-header bg-transparent border-bottom">
                <h5 class="mb-0">Transaction</h5>
                            ...
                            <div class="p-4">
                                    ...
                                    <form action="walkinsupplyincoming.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <script>
                                                        ...
                                                        $('.transpartner_1').change(function(){
                                                            ...
                                                            var transpartner_1 = $('.transpartner_1').val();                                                    
                                                                $.ajax({
                                                                    url:"walkinsupplyfetchpartner.php",
                                                                    method:"POST",
