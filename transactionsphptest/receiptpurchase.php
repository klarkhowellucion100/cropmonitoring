                            ...
                            <div class="card">
                                ...
                                <table id="table_collect" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                     ...
                                     <tbody>
                                         <?php
                                             include 'db.inc.php';
                                             $query001 = mysqli_query($conn,"SELECT trans_code, trans_partner, trans_partnercode, trans_partnertype, trans_adate, trans_status, ftrans_encoder, SUM(pay_subtotal_final) FROM erp_record WHERE trans_partnertype='Farmer' AND trans_adate='$date_f' GROUP BY trans_code");
                                         ...
                                         <tr>
                                                ...
                                                <td><a href="receiptpurchaseviewtransaction.php?view=<?php echo $result001 ['trans_code'];?>"><?php echo $result001 ['trans_code']; ?></a></td>   
                                                <td><?php echo $result001 ['trans_partner']; ?></td> 
                                                <td><?php echo $status_final; ?></td> 
                                                <td style='display:none;'><input type="text" readonly id='codehidden' value='<?php echo $result001 ['trans_code'];?>'></td>
                                                <td><?php echo $result001 ['SUM(pay_subtotal_final)']; ?></td> 
                                               <td> <button onClick="updateme('update=<?php echo $result001 ['trans_code'];?>')" <?php if ($status_final == "Paid") { echo 'disabled'; } ?> class="btn  btn-raised btn-warning waves-effect">Paid</button></td>

                                                <script>
                                                    function updateme(delid){
                                                        if(confirm("Are you sure you want to update this data to Paid?")){
                                                        window.location.href='receiptpurchaseupdate.php?' +delid+ '';
