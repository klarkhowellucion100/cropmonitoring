...
<div class="row" >
                        <div class="col-6 mx-auto">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0" >Commitment Detail</h4>
                                <a class='btn btn-primary' href="supplyreceive.php" style="margin-top: 20px;"> Exit </a> 
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Receipt</a></li>
                                        <li class="breadcrumb-item active">Commitment Detail</li>
                                    </ol>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Received Volume</h5>
                        ...
                        <div class="col-lg-6 mx-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h4>Transaction No.: <?php echo $trans_code;?></h4>
                                        <h5 style="font-size:12px; color:black;">Order summary</h5> <button class="btn btn-primary addproduct" data-bs-toggle="modal" data-bs-target="#myModal01"><i class="uil-plus"></i></button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control stype_1 stype_2 stype_3 stype_4 stype_5" id="trans_sellingtype" value="Farmgate">
                                                                </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <label for="region">Commodity Type</label>                                                       
                                                                            ...
                                                                            <option value="">Pease Select Commodity *</option>
                                                                                <?php  
                                                                                    $sql = "SELECT * FROM commodityhubpos GROUP BY `type`";
                                                                    ...
                                                                    <script>
                                                                        ...
                                                                        $('.commt_1').change(function(){
                                                                            ...
                                                                            var stype_1 = $('.stype_1').val();                                               
                                                                                $.ajax({
                                                                                    url:"supplyreceivedviewfetch.php",
                                                                                    method:"POST",
                                                                                    data:{commt_1:commt_1,stype_1:stype_1},
                                                                ...
                                                                <script>
                                                                        ...
                                                                        $('.comm_2').change(function(){
                                                                    
                                                                            var commt_2 = $('.commt_2').val();       
                                                                            var stype_2 = $('.stype_2').val();  
                                                                            var comm_2 = $('.comm_2').val();                                                   
                                                                                $.ajax({
                                                                                    url:"supplyreceivedviewfetch.php",
                                                                                    method:"POST",
                                                                                    data:{commt_2:commt_2,stype_2:stype_2,comm_2:comm_2},
                                                                                    success:function(data){
                                                                                        $('.comcl_2').html(data);
                                                                                    }
                                                                                });
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <div class="commo">
                                                                        <label for="municipality">Commodity Class</label>                                                       
                                                                            <select id="trans_class" class="form-select comcl_1 comcl_2 comcl_3 comcl_4 comcl_5">
                                                                ...
                                                                <script>
                                                                        ...
                                                                        $('.comcl_3').change(function(){
                                                                    
                                                                            var commt_3 = $('.commt_3').val();       
                                                                            var stype_3 = $('.stype_3').val();  
                                                                            var comm_3 = $('.comm_3').val();     
                                                                            var comcl_3 = $('.comcl_3').val();                                            
                                                                                $.ajax({
                                                                                    url:"supplyreceivedviewfetch.php",
                                                                                    method:"POST",
                                                                                    data:{commt_3:commt_3,stype_3:stype_3,comm_3:comm_3,comcl_3:comcl_3},
                                                                                    success:function(data){
                                                                                        $('.price_4').html(data);
                                                                                    }
                                                                                });
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <label for="province">Price</label>                                                       
                                                                            <select id="trans_price" class="form-select price_4">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table-centered table table-wrap mb-0" style="width:100%;" >
                                                ...
                                                <tr>
                                                        ...
                                                        <th style="width: 100px;  font-size:12px; font-weight: bold; color:black;">Comm</th>        
                                                        ...
                                                        <th style="width: 100px;  font-size:12px; font-weight: bold; color:black;">Com</th>    
                                                        <th style="width: 100px;  font-size:12px; font-weight: bold; color:black;">Act</th>                            
                                                        <th  style="width: 50px;  font-size:12px; font-weight: bold; color:black;">Sub</th>
                                                        <th  style="width: 50px;  font-size:12px; font-weight: bold; color:black;">Update</th>
                                                        <th  style="width: 50px;  font-size:12px; font-weight: bold; color:black;">Delete</th>
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td style="width: 50px;  font-size:11px; color:black;"><?php echo $result2['trans_commitvol'];?>kg</td>
                                                    ...
                                                    <input type="hidden" value="<?php echo $trans_code; ?>" id="code_trans">
                                                        ...
                                                        <td colspan="3" style="font-size:15px; color:black; margin-bottom: 20px; text-align: right;">
                                                    ...
                                                    <script>
                                                         function addcomm(){
                                                                ...
                                                                var trans_volume= $('#trans_volume').val(); 
                                                                        ...
                                                                        $.ajax({
                                                                                url:"supplyreceivedadditional.php",
                                                                                method:"POST",
