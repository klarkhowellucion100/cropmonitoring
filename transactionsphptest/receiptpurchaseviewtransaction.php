...
<div class="row" >
                        <div class="col-6 mx-auto">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <a class='btn btn-primary' href="receiptpurchase.php" style="margin-top: 20px;"> Exit </a> 
                        ...
                        <div class="col-lg-6 mx-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <h5 style="font-size:12px; color: darkblue;">Payment Summary (Farmer Partners)</h5>
                                            ...
                                            <table class="table-centered table table-wrap mb-0" style="width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <tr style="font-size: 11px;">
                                                        ...
                                                        <td colspan="2" style="text-align: left; color: darkblue;">Approved by:</td>
