...
<div class="row">
                    ...
                    ?>
                        ...
                        <?php
                        $query1 = mysqli_query($conn,"SELECT * FROM commodityhubpos WHERE (`commodity` LIKE '%$commodity_main%') AND `sellingtype`='Farmgate' AND classcom='Class A' ORDER BY commodity ASC");
