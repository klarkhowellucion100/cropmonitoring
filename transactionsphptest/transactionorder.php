                                    ...
                                    <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example" id="commodity_main">
                                                            ...
                                                            <?php  
                                                                $sql = "SELECT * FROM commodityhubpos GROUP BY commodity";
            ...
            <div id="type_purchase">
                <div class="row">
                    ...
                    ?>
                        ...
                        <?php
                        $query1 = mysqli_query($conn,"SELECT * FROM commodityhubpos  WHERE `sellingtype`='Wholesale' AND `classcom`='Class A' ORDER BY commodity ASC");
                        ...
                        <div class="col-xl-4 col-sm-6">
                            <div class="product-box">
                                ...
                                <div class="text-center product-content p-4">
                                    ...
                                    <p class="text-muted font-size-13" id="class_type"><?php echo $q['type']; ?></p>
...
<script>
     function addproduct(){
                                ...
                                var trans_commitvol= $('#trans_commitvol').val();
                                        ...
                                        $.ajax({
                                                url:"transactionorderinsert.php",
                                                method:"POST",
                            ...
                            function DeleteUser(deleteid){
                                ...
                                if(confirm("Are you sure you want to delete this data?")){
                                    $.ajax({
                                                url:"transactionordertransdelete.php",
                                                method:"POST",
                    ...
                    <script>
                            ...
                            function displayData(){
                                    ...
                                    $.ajax({
                                        url:"transactionorderdisplay.php",
                                        type:"POST",
                                        data:{
            ...
            <div class="card-header bg-transparent border-bottom">
                <h5 class="mb-0">Transaction</h5>
                            ...
                            <div class="p-4">
                                    ...
                                    <form action="transactionsorderincoming.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <script>
                                                        ...
                                                        $('.transpartner_1').change(function(){
                                                            ...
                                                            var transpartner_1 = $('.transpartner_1').val();                                                    
                                                                $.ajax({
                                                                    url:"transactionorderfetchpartner.php",
                                                                    method:"POST",
