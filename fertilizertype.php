                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Fertilizer Category/Type Registration</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                                        <li class="breadcrumb-item active">Fertilizer Category</li>
                                    </ol>
                                </div>
                    ...
                    <!-- end page title -->
                       ...
                       <?php  
                        ...
                        <?php
                            ...
                            $finalcode='FC'.date('Y').''.date('d').''.createRandomPassword().''.date('m');
                        ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="myModalLabel">Add Fertilizer Category/Type</h5>
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-0">
                                                                    <div class="commo">
                                                                        <label style="color:royalblue;">FERTILIZER CATEGORY/TYPE INFORMATION</label>                                                                         
                                                                    </div>                                        
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="commo">
                                                                        ...
                                                                        <input type="text" required class="form-control" id="fert_type" placeholder='Enter Type *' name='fert_type'>      
                                                                    </div>                                        
                                                                </div>
                                    ...
                                    <h4 class="card-title">Fertilizer Category List </h4>    

                                    <div style="padding-bottom:10px;"> <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal">Add Fertilizer Category/Type +</button></div>                                    
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                include 'db.inc.php';
                                                $query1 = mysqli_query($conn,"SELECT * FROM fertilizer_type_cms ORDER BY `fert_type` ASC");
  ...
  if (result.isConfirmed) {
    swalWithBootstrapButtons.fire(
      ...
      'success'
        ...
        window.location.href='fertilizertypedelete.php?delete=' +delid+ '';
        });
