                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Pest and Disease Registration</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                                        <li class="breadcrumb-item active">Pests and Disease</li>
                                    </ol>
                                </div>
                    ...
                    <!-- end page title -->
                       ...
                       <?php  
                        ...
                        <?php
                            ...
                            $finalcode='PD'.date('Y').''.date('d').''.createRandomPassword().''.date('m');
                        ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="myModalLabel">Add Pest/Disease</h5>
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-0">
                                                                    <div class="commo">
                                                                        <label style="color:royalblue;">PEST/DISEASE INFORMATION</label>                                                                         
                                                                    </div>                                        
                                                                </div>
                                                                ...
                                                                <div class="mb-3" style="display:none;">
                                                                    <div class="commo">
                                                                        ...
                                                                        <input type="text" required class="form-control" id="encoder" name='encoder' value="<?php echo $userid;?>">      
                                                                    </div>                                        
                                                                </div>
                                    ...
                                    <h4 class="card-title">Pest/Disease List </h4>    

                                    <div style="padding-bottom:10px;"> <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal">Add Pest/Disease +</button></div>                                    
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                include 'db.inc.php';
                                                $query1 = mysqli_query($conn,"SELECT * FROM pest_cms ORDER BY `name` ASC");
  ...
  if (result.isConfirmed) {
    swalWithBootstrapButtons.fire(
      ...
      'success'
        ...
        window.location.href='pestanddiseasedelete.php?delete=' +delid+ '';
        });
