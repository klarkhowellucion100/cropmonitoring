...
! function(e, t) {
    ...
    var lt = function() {
        ...
        ct = function() {
            ...
            return e.prototype.setProp = function(e, t) {
                var n, r;
                if (e in Ft);
                else if (e in At) "function" == typeof At[e] && (t = At[e](t)), this.mutate({
    ...
    var gr = function(e) {
        ...
        yr = function(e) {
            ...
            return Ee(t, e), t.prototype.render = function(e, t) {
                ...
                this.updateElClassNames(e), u(this.el, this.contentEl = r("div", {
                ...
                d ? (o || (o = this.header = new gr("fc-header-toolbar"), u(this.el, o.el)), o.receiveProps(Se({
                    layout: d
                }, m), i)) : o && (o.destroy(), o = this.header = null), f ? (a || (a = this.footer = new gr("fc-footer-toolbar"), s(this.el, a.el)), a.receiveProps(Se({
                    layout: f
                }, m), i)) : a && (a.destroy(), a = this.footer = null)
    ...
    var Cr = function() {
        ...
        return e.prototype.addPluginInputs = function(e) {
            ...
            var n = function(e, t) {
                ...
                r = [Tr, wr].concat(this.pluginSystem.hooks.componentInteractions).map((function(e) {
                    return new e(n)
                }));
            ...
            var n = ur(null == t ? null != e.start ? e : {
                start: e,
                end: null
            } : {
                start: e,
    ...
    var xr = function(e) {
        ...
        return Ee(t, e), t.prototype.initialize = function() {}, Object.defineProperty(t.prototype, "activeStart", {
            ...
            this.renderDates(e), this.addScroll({
                duration: J(this.context.options.scrollTime)
            })
        ...
        }, t.prototype.renderEventResize = function(e) {}, t.prototype.unrenderEventResize = function(e) {}, t.prototype.startNowIndicator = function(e, t) {
            var n, r, i, o = this,
                a = this.context,
                s = a.calendar,
                u = a.dateEnv;
        ...
        }, t.prototype.getNowIndicatorUnit = function(e, t) {}, t.prototype.renderNowIndicator = function(e) {}, t.prototype.unrenderNowIndicator = function() {}, t.prototype.addScroll = function(e, t) {
    ...
    var Ur = function() {
            ...
            return e.prototype.getSegsByType = function(e) {
                ...
                }), "highlight" !== e && (r = r.concat(t.eventRange.ui.classNames)), "businessHours" === e ? r.push("fc-bgevent") : r.push("fc-" + e.toLowerCase()), "<" + this.fillSegTag + (r.length ? ' class="' + r.join(" ") + '"' : "") + (n ? ' style="' + xt(n) + '"' : "") + "></" + this.fillSegTag + ">"
    ...
    function Wr(e, t, n, r, i, o, a, s) {
        ...
        return u = "function" == typeof d.columnHeaderHtml ? d.columnHeaderHtml(l.toDate(e)) : "function" == typeof d.columnHeaderText ? Pt(d.columnHeaderText(l.toDate(e))) : Pt(l.format(e, i)), n ? p = p.concat(en(e, t, o, !0)) : p.push("fc-" + P[e.getUTCDay()]), '<th class="' + p.join(" ") + '"' + (f && n ? ' data-date="' + l.formatIso(e, {
            omitTime: !0
        }) + '"' : "") + (a > 1 ? ' colspan="' + a + '"' : "") + (s ? " " + s : "") + ">" + (f ? $t(d, l, {
            date: e,
            forceOff: !n || 1 === r
        }, u) : u) + "</th>"
    }
