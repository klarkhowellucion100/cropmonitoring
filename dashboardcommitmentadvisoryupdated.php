...
<?php
    ...
    $finalcode='ADV'.date('Y').''.date('d').''.createRandomPassword().''.date('m');
?>
                    ...
                    <?php
                        ...
                        while($q = mysqli_fetch_array($query1)): ?>
                                            ...
                                            <div class="mb-3" style="display:none;">
                                                ...
                                                <input style="display:none;" type="text" class="form-control" name="val_code" id="val_code" readonly value="<?php echo $finalcode;?>">
                                                <p><?php echo $q['code'];?></p>
                                            </div>
                                            ...
                                            <script>
                                                ...
                                                $('#filter_btn').click(function(){
                                                    ...
                                                    var val_date_trans = $('#val_date_trans').val();                                     
                                                        $.ajax({
                                                            url:"dashboardcommitmentadvisoryupdatefetch.php",
                                                            method:"POST",
                                                            data:{val_id:val_id,
                                                                val_code:val_code,
                                                                val_name:val_name,
