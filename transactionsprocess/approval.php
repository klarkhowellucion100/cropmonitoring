                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <?php if($userposition=="President" || $userposition=="Vice President" || $userposition=="Secretary"){?>
                                                        <table class="table mb-0">
                                                            ...
                                                            <?php
                                                                include 'db.inc.php';
                                                                $query = mysqli_query($conn, "SELECT * FROM usertableclanapp");
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $result['specloc']; ?> <?php echo $result['barangay']; ?>, <?php echo $result['municipality']; ?>, <?php echo $result['province']; ?>, <?php echo $result['region']; ?></td>
                                                                    <td><?php echo $result['clanname']; ?></td>
                                                                    <td><?php echo $result['regval']; ?></td>
                                                                    <td style='display:none;'><input type="text" readonly id='codehidden' value='<?php echo $result ['id'];?>'></td>
                                                                    <td> <button onClick="updatemeaccept('updateaccept=<?php echo $result ['id'];?>')" <?php if ($result['regval'] == "Accept") { echo 'disabled'; } ?> class="btn  btn-raised btn-warning waves-effect">Accept</button></td>
                                                                </tr>
