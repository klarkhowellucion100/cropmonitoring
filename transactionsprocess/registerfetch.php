...
?>
                                                            ...
                                                            <?php  
                                                                $sql = "SELECT * FROM areasclanapp WHERE region='$region_1' GROUP BY province";
...
?>
                                                            ...
                                                            <?php  
                                                                $sql1 = "SELECT * FROM areasclanapp WHERE region='$region_0' AND province='$province_0' GROUP BY municipality";
...
?>
                                                            ...
                                                            <?php  
                                                                $sql10 = "SELECT * FROM areasclanapp WHERE region='$region_2' AND province='$province_2' AND municipality='$mun_01' GROUP BY barangay";
