...
if(isset($_POST['farmer_1'])){ ?>


<?php 

$farmer_1 = $_POST['farmer_1'];
...
?>
                                                            ...
                                                            <?php  
                                                                $sql = "SELECT * FROM registrationhubpos WHERE fname='$farmer_1' GROUP BY code";
...
if(isset($_POST['farmer_0'])){ ?>


<?php 

$farmer_0 = $_POST['farmer_0'];
...
?>
                                                            ...
                                                            <?php  
                                                                $sql1 = "SELECT * FROM registrationhubpos WHERE fname='$farmer_0' GROUP BY `type`";
