...
isset($_POST['quniquetwo']) && isset($_POST['qsuggest']) && isset($_POST['fnametype'])){
    ...
    $sql="insert into `feedbackrecord` 
    (feedcode,fname,fnamecode,
    feeddate,numdel,quniqueone,
    qone,qoner,qtwo,
    qtwor,qthree,qthreer,
    qfour,qfourr,qfive,
    qfiver,qsix,qsixr,
    quniquetwo,qsuggest,fnametype)
    values ('$feedcode','$fname','$fnamecode',
    '$feeddate','$numdel','$quniqueone',
    '$qone','$qoner','$qtwo',
    '$qtwor','$qthree','$qthreer',
    '$qfour','$qfourr','$qfive',
