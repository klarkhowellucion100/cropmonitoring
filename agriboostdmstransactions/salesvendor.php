                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        ...
                                                        <h5 class="font-size-16 mb-0"><?php  echo $result001['total_buyqty']; ?> kg</h5>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        <p class="text-muted mb-2">Total Purchase(Php)</p>
                                                        <h5 class="font-size-16 mb-0"><?php  echo $result001['total_purchase']; ?> kg</h5>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        <p class="text-muted mb-2">Volume Sold(kg)</p>
                                                        <h5 class="font-size-16 mb-0"><?php  echo $result001['total_soldqty']; ?> kg</h5>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="mt-3">
                                                        <p class="text-muted mb-2">Total Sales(Php)</p>
                                                        <h5 class="font-size-16 mb-0"><?php  echo $result001['total_sales']; ?> kg</h5>
                                                    </div>
                                                </div>
