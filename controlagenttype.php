                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Control Category/Type Registration</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tables</a></li>
                                        <li class="breadcrumb-item active">Control Agent Category</li>
                                    </ol>
                                </div>
                    ...
                    <!-- end page title -->
                       ...
                       <?php  
                        ...
                        <?php
                            ...
                            $finalcode='CAT'.date('Y').''.date('d').''.createRandomPassword().''.date('m');
                        ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="myModalLabel">Add Control Agent Category/Type</h5>
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="mb-0">
                                                                    <div class="commo">
                                                                        <label style="color:royalblue;">CONTROL AGENT CATEGORY/TYPE INFORMATION</label>                                                                         
                                                                    </div>                                        
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="commo">
                                                                        ...
                                                                        <input type="text" required class="form-control" id="cont_type" placeholder='Enter Type *' name='cont_type'>      
                                                                    </div>                                        
                                                                </div>
                                    ...
                                    <h4 class="card-title">Control Agent Category List </h4>    

                                    <div style="padding-bottom:10px;"> <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal">Add Control Agent Category/Type +</button></div>                                    
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                include 'db.inc.php';
                                                $query1 = mysqli_query($conn,"SELECT * FROM controlagent_type_cms ORDER BY `cont_type` ASC");
    ...
    function addcomm(){
        var data = {                                 
            ...
            cont_code: $("#cont_code").val(),
                   ...
                   $.ajax({
                           url:"controlagenttypeprocess.php",
                           method:"POST",
                           data:data,
  ...
  if (result.isConfirmed) {
    swalWithBootstrapButtons.fire(
      ...
      'success'
        ...
        window.location.href='controlagenttypedelete.php?delete=' +delid+ '';
        });
